  ...
  render(h) {
    return (
      <div class='data-filter'>
        ...
        <div class={['filter-list', { showAll: this.expand }]}>
        ...
        </div>
        {
          this.isHedden ? <div>
            ...
            {this.expandSwitch ? <span class='expand g-link' style='margin-left: 15px; color: #E6001F;cursor:pointer' on-click={this.filterShowAll} >{this.expand ? '收起' : '展开'}<i class={['fa', !this.expand ? 'fa-angle-down' : 'fa fa-angle-up']}></i></span> : ''}
          </div>
            : <div>
              <el-button
                type='primary'
