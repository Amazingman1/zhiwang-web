<template>
  <div>
    ...
    <uploadmany :filesType="filesType" :config="config" />
    <span @click="getpick" style="margin:20px">点击查看上传的图片</span>
    ...
    <data-list :filters="filterList" @data-refresh="handleRefresh" :total="total" ref="datalist">
      ...
      <el-table :data="listData" highlight-current-row style="width: 100%;">
        ...
        <el-table-column prop="applyCode" label="申请编号" min-width="190"></el-table-column>
        <el-table-column prop="custName" label="客户姓名" min-width="150"></el-table-column>
        <el-table-column prop="idCode" label="证件号码" min-width="200"></el-table-column>

        <el-table-column prop="carBrandName" label="品牌" min-width="150"></el-table-column>
