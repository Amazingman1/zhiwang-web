...
export default {
  ...
  adds: Number.prototype['adds'] = function(...arg) {
    var r1; var r2; var m; var result = this
    arg.forEach(value => {
  ...
  mul: Number.prototype['mul'] = function(...arg) {
    var result = this
    arg.forEach(value => {
      var m = 0; var s1 = result.toString(); var s2 = value.toString()
  ...
  divide: Number.prototype['divide'] = function(...arg) {
    ...
    arg.forEach(value => {
      ...
      try { t1 = result.toString().split('.')[1].length } catch (e) { console.log(e) }
      try { t2 = value.toString().split('.')[1].length } catch (e) { console.log(e) }
